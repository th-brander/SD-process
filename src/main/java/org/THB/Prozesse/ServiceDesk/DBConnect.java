...
//CREATE TABLE SDDATA (TICKETID int(11)  AUTO_INCREMENT(10000,1),STATUS varchar (20),Tickettyp varchar(20),user varchar(15),prio varchar(10), title varchar(8), dat Timestamp, firstN varchar(15), lastN varchar(15), phoneN varchar(15),email varchar(30), description clob,PRIMARY KEY (TicketID))
public class DBConnect implements JavaDelegate {
	...
	public void execute(DelegateExecution execution) throws Exception {
		...
		try {
			...
			String sql = "INSERT INTO SDDATA (STATUS,TICKETTYP,USER,PRIO,TITLE,DAT,FIRSTN,LASTN,PHONEN,EMAIL,DESCRIPTION) VALUES ('in Bearbeitung','" + vartickettyp + "','" + varuser + "','" + varprio + "','" + vartitle + "','" + timestamp +"','"+ varfirstN + "','"+ varlastN + "','"+ varphoneN + "','" + varemail +"','"+ vardescription + "')";
